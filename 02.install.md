...
Інструкція з встановлення Gray Log 5.x на Ubuntu 22.04
...
Оперативна пам'ять (RAM): Мінімум 4 ГБ для лабораторного середовища та 8 ГБ для реального середовища

Процесор (CPU): Мінімум 2 ядра для лабораторного середовища та 4 ядра для реального середовища

Диск: Мінімум 10 ГБ

Вимоги до програмного забезпечення

Java: Graylog вимагає Java 8 або Java 11. Переконайтеся, що встановлено OpenJDK або Oracle JDK. OpenJDK 17 (вбудований у Graylog, окреме встановлення не потрібне).

Elasticsearch: Graylog використовує Elasticsearch для індексації та пошуку даних логів. Рекомендована версія Elasticsearch 7.x.

MongoDB: Graylog використовує MongoDB для зберігання конфігурацій та метаданих. Підтримуються версії MongoDB 5.x або 6.x.

Вимоги до фаєрволу

Порт 9000: Для доступу до веб-інтерфейсу Graylog

Порти 9200 та 9300: Для роботи Elasticsearch

Порт 27017: Для роботи MongoDB
